...
export default function PublicationCreateForm() {
  ...
  // ✅ фикс: не отдаём options с id=null -> "null"
  ...
  const pickFromList =
    (list: Array<{ id: number | null; name?: string | null }>, field: "authors" | "subjects" | "tags") =>
    (val: string) => {
      const id = Number(val);
        ...
        <div className={styles.left}>
          ...
          <div className={styles.multiField}>
            ...
            <SelectSearchAdd
              ...
              onCreate={async (name) => {
                try {
                  const opt = await createAndAdd("authors", createAuthor, setAllAuthors)(name);
                  dispatch(show({ type: "success", message: "Автор добавлен" }));
                  return opt;
                } catch (e) {
                  dispatch(show({ type: "error", message: "Не удалось добавить автора" }));
                  throw e;
                }
              }}
              onDelete={async (opt) => {
                ...
                try {
                  ...
                  if (!ok) {
                    dispatch(show({ type: "error", message: "Не удалось удалить автора" }));
                    return;
                  }
                  ...
                  dispatch(show({ type: "error", message: "Ошибка при удалении автора" }));
                }
              }}
            />
          </div>
        ...
        <div className={styles.right}>
            ...
            <SelectSearchAdd
              ...
              onDelete={async (opt) => {
                ...
                try {
                  ...
                  if (!ok) {
                    dispatch(show({ type: "error", message: "Не удалось удалить тег" }));
                    return;
                  }
                  ...
                  dispatch(show({ type: "error", message: "Ошибка при удалении тега" }));
                }
              }}
            />
          </div>
          ...
          <div className={styles.multiField}>
            ...
            <SelectSearchAdd
              ...
              onCreate={async (name) => {
                try {
                  // ✅ фикс: createSubject + setAllSubjects
                  const opt = await createAndAdd("subjects", createSubject, setAllSubjects)(name);
                  dispatch(show({ type: "success", message: "Предмет добавлен" }));
                  return opt;
                } catch (e) {
                  dispatch(show({ type: "error", message: "Не удалось добавить предмет" }));
                  throw e;
                }
              }}
              onDelete={async (opt) => {
                ...
                try {
                  ...
                  if (!ok) {
                    dispatch(show({ type: "error", message: "Не удалось удалить предмет" }));
                    return;
                  }
                  ...
                  dispatch(show({ type: "error", message: "Ошибка при удалении предмета" }));
                }
              }}
            />
          </div>
